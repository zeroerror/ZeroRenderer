...
namespace test {
	...
	PipelineTest::PipelineTest() {
		...
		m_shaderRepo = ShaderRepo();
		m_textureRepo = TextureRepo();
	}
	...
	void PipelineTest::Ctor(GLFWwindow* window, const int& screen_width, const int& screen_height) {

		// ====== Asset Load
		// - Asset Path to AssetID
