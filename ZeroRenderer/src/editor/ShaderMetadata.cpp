...
void ShaderMetadata::SerializeTo(const std::string& path) {
	std::stringstream ss;
	ss << "guid: " << guid << std::endl;
	ss << "useLightingMVP: " << useLightingMVP << std::endl;
...
void ShaderMetadata::DeserializeFrom(const std::string& path) {
