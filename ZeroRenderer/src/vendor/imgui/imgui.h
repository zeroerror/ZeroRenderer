...
namespace ImGui
{
    ...
    IMGUI_API bool          DragScalarN(const char* label, ImGuiDataType data_type, void* p_data, int _components, float v_speed = 1.0f, const void* p_min = NULL, const void* p_max = NULL, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalarN(const char* label, ImGuiDataType data_type, void* p_data, int _components, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          InputScalarN(const char* label, ImGuiDataType data_type, void* p_data, int _components, const void* p_step = NULL, const void* p_step_fast = NULL, const char* format = NULL, ImGuiInputTextFlags flags = 0);
